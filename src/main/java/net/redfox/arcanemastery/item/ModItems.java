...
import net.redfox.arcanemastery.item.custom.FireStaffItem;
...
public class ModItems {
    ...
    public static final Item FIRE_STAFF = registerItem("fire_staff",new FireStaffItem(new Item.Settings().maxCount(1)), ModItemGroup.ARCANE_MASTERY);
