package net.redfox.arcanemastery.block.custom;
...
public class FireLanternBlock extends Block implements Waterloggable {
    ...
    public FireLanternBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        Direction direction = FireLanternBlock.attachedDirection(state).getOpposite();
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        ...
        if (FireLanternBlock.attachedDirection(state).getOpposite() == direction && !state.canPlaceAt(world, pos)) {
